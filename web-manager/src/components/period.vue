    ...
    <el-row>
      <el-col :span="24">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>时代</el-breadcrumb-item>
        </el-breadcrumb>
      </el-col>
    </el-row>
            ...
            <el-table-column prop = "title" label = "标题"></el-table-column>
             <el-table-column fixed="right" label="操作">
                <template slot-scope="scope">
                    <el-button type="text" size="small" @click = "go('periodEdit', scope.row.id )">编辑</el-button>
                </template>
            </el-table-column>
        </el-table>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    initTable() {
      ...
      axios
        .post(_this.GLOBAL.url_period_list, {
